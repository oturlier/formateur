...
Les 2 systèmes ci-dessous ont le mérite de crypter les infos qui circulent. Je n'ose pas décrire leur utilisation, à vous de voir!

Un clic sur l'image et vous y êtes...
